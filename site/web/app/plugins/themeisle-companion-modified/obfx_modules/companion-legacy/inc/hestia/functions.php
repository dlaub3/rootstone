 ...
 *
 * @author Themeisle
 * @package themeisle-companion-modified
 */
...
function themeisle_hestia_set_frontpage() {
	if ( function_exists( 'hestia_setup_theme' ) ) {
		...
		if ( (bool) $is_fresh_site === false ) {
			$frontpage_title = esc_html__( 'Front Page', 'themeisle-companion-modified' );
			$front_id = themeisle_hestia_create_page( 'hestia-front', $frontpage_title );
			$blogpage_title = esc_html__( 'Blog', 'themeisle-companion-modified' );
