...
if ( ! function_exists( 'hestia_testimonials_customize_register' ) ) :
	...
	function hestia_testimonials_customize_register( $wp_customize ) {
		...
		$wp_customize->add_section( 'hestia_testimonials', array(
			'title'    => esc_html__( 'Testimonials', 'themeisle-companion-modified' ),
		...
		$wp_customize->add_control( 'hestia_testimonials_hide', array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Disable section', 'themeisle-companion-modified' ),
		...
		$wp_customize->add_control( 'hestia_testimonials_title', array(
			'label'    => esc_html__( 'Section Title', 'themeisle-companion-modified' ),
			'section'  => 'hestia_testimonials',
			'priority' => 5,
		) );
		...
		$wp_customize->add_control( 'hestia_testimonials_subtitle', array(
			'label'    => esc_html__( 'Section Subtitle', 'themeisle-companion-modified' ),
			'section'  => 'hestia_testimonials',
			'priority' => 10,
		) );
		...
		if ( class_exists( 'Hestia_Repeater' ) ) {
			...
			$wp_customize->add_control( new Hestia_Repeater( $wp_customize, 'hestia_testimonials_content', array(
				'label'                                => esc_html__( 'Testimonials Content', 'themeisle-companion-modified' ),
				'section'                              => 'hestia_testimonials',
				'priority'                             => 15,
				'add_field_label'                      => esc_html__( 'Add new Testimonial', 'themeisle-companion-modified' ),
				'item_name'                            => esc_html__( 'Testimonial', 'themeisle-companion-modified' ),
