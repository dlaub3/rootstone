...
if ( ! function_exists( 'hestia_features' ) ) :
	...
	function hestia_features() {
		...
		if ( current_user_can( 'edit_theme_options' ) ) {
			$default_title = __( 'Why our product is the best', 'themeisle-companion-modified' );
...
function hestia_get_features_default() {
	return apply_filters( 'hestia_features_default_content', json_encode( array(
		array(
			...
			'title'      => __( 'Responsive', 'themeisle-companion-modified' ),
			'text'       => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'themeisle-companion-modified' ),
			'link'       => '#',
			'color'      => '#e91e63',
		),
		array(
			'icon_value' => 'fa-check',
			'title'      => __( 'Quality', 'themeisle-companion-modified' ),
			'text'       => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'themeisle-companion-modified' ),
			'link'       => '#',
			'color'      => '#00bcd4',
		),
		array(
			...
			'title'      => __( 'Support', 'themeisle-companion-modified' ),
			'text'       => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'themeisle-companion-modified' ),
			'link'       => '#',
			'color'      => '#4caf50',
		),
