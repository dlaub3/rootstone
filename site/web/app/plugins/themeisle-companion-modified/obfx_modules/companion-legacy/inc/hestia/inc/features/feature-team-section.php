...
if ( ! function_exists( 'hestia_team_customize_register' ) ) :
	...
	function hestia_team_customize_register( $wp_customize ) {
		...
		$wp_customize->add_section( 'hestia_team', array(
			'title'    => esc_html__( 'Team', 'themeisle-companion-modified' ),
		...
		if ( class_exists( 'Hestia_Repeater' ) ) {
			...
			$wp_customize->add_control( new Hestia_Repeater( $wp_customize, 'hestia_team_content', array(
				'label'                                => esc_html__( 'Team Content', 'themeisle-companion-modified' ),
				'section'                              => 'hestia_team',
				'priority'                             => 15,
				'add_field_label'                      => esc_html__( 'Add new Team Member', 'themeisle-companion-modified' ),
				'item_name'                            => esc_html__( 'Team Member', 'themeisle-companion-modified' ),
