...
class Companion_Legacy_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	public function __construct() {
		parent::__construct();
		$this->name        = __( 'Companion Legacy', 'themeisle-companion-modified' );
		$this->description = __( 'Module containing legacy functionality from ThemeIsle Companion.', 'themeisle-companion-modified' );
	...
	public function rhea_add_html_to_admin_footer() {
        ...
        <div id="fontawesome-popup">
            <div class="left-side">
                <label for="fontawesome-live-search">' . esc_html_e( 'Search icon', 'themeisle-companion-modified' ) . ':</label>
                <ul class="filter-icons">
                    <li data-filter="all" class="active">' . esc_html_e( 'All Icons', 'themeisle-companion-modified' ) . '</li>
                </ul>
            </div>
