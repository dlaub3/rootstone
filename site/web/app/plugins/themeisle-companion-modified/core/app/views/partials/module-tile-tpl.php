...
if ( ! isset( $name ) ) {
	$name = __( 'Module Name', 'themeisle-companion-modified' );
}

if ( ! isset( $description ) ) {
	$description = __( 'Module Description ...', 'themeisle-companion-modified' );
}
	...
	<div class="tile-action">
		<div class="form-group">
			<label class="form-switch">
				...
				<i class="form-icon"></i><?php echo  __( 'Activate', 'themeisle-companion-modified' ); ?>
			</label>
		</div>
	</div>
</div>
