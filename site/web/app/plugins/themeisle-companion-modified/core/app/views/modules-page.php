...
<div class="obfx-wrapper obfx-header">
	<div class="obfx-header-content">
		...
		<h1><?php echo __( 'Orbit Fox Companion', 'themeisle-companion-modified' ); ?></h1><span class="powered"> by <a
	...
	if ( $no_modules ) {
		...
		<div class="panel">
			<div class="panel-header text-center">
				<div class="panel-title mt-10"><?php echo __( 'Available Modules', 'themeisle-companion-modified' ); ?></div>
			</div>
		...
		<div class="panel">
			<div class="panel-header text-center">
				<div class="panel-title mt-10"><?php echo __( 'Activated Modules Options', 'themeisle-companion-modified' ); ?></div>
			</div>
			<?php echo ( $panels == '' ) ? '<p class="text-center">' . __( 'No modules activated.', 'themeisle-companion-modified' ) . '</p>' : $panels; ?>
		</div>
		<?php
	}
	?>
