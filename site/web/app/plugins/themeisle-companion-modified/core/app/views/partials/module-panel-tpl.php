...
if ( ! isset( $name ) ) {
	$name = __( 'The Module Name', 'themeisle-companion-modified' );
}

if ( ! isset( $description ) ) {
	$description = __( 'The Module Description ...', 'themeisle-companion-modified' );
}

if ( ! isset( $options_fields ) ) {
	$options_fields = __( 'No options provided.', 'themeisle-companion-modified' );
}
